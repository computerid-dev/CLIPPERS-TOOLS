...
import brandLogo from "@/assets/nugroho-keren-logo.png";
        ...
        <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-5">
          <Link to="/" className="flex items-center gap-2 focus-ring rounded-full">
            <span className="flex size-8 items-center justify-center overflow-hidden rounded-xl">
              <img src={brandLogo} alt="Nugroho Keren Dev" className="size-full object-cover" />
            </span>
        ...
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-5 text-sm text-muted-foreground sm:flex-row">
          <div className="text-center sm:text-left">
            ...
            <p className="mt-1 text-xs">
              Developed by <span className="font-medium text-foreground">Nugroho Keren Dev</span>
            </p>
          </div>
